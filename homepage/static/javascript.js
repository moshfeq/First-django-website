	...
	$(document).ready(function(){ /*-----to get the document ready----*/	
		 ...
		 $(".header_head").fadeIn(700);/*-----for the header heading animation----*/	
		 $(".header_head_post").fadeIn(700);/*-----for the header heading animation----*/	
         ...
         $(".post_img").hover(function() { /*----------for post_image hover effect----------------*/
			 $(this).stop(true,true).addClass('opacity2',350)
         },function(){
			$(this).stop(true,true).removeClass('opacity2',350);
		 });		 
